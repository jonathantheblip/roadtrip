...
export function AureliaView({ trip, traveler, pastTrips, onPlayPastTrip, onOpenStop, onOpenActivities, onOpenPhotos, onOpenAllPhotos, onShowMe, onOpenSettings, onOpenMap, onOpenWeave, onOpenReplay, onOpenBook, onCompose, onOpenEditor, onKeepDay, onTuckPendingNote, weaveReady, bookHasPages, surpriseRevealCue, nowReadout, whoAround }) {

// timeWitness.js — WORKER MIRROR of app/src/lib/timeWitness.js. The D14 / D1-
// qualifier PURE witnesses (BUILD_PLAN_WITNESS_FLEET_2.md W8, "the time-witness
// pack"): reusable, mirror-safe (no I/O) classifiers consumed by sessionHeal.js's
// point-builder on BOTH sides. Byte-identical to the client copy (no imports on
// either side, so there is nothing for the two files to differ on) — a parity
// test still gates them against drift.
//
